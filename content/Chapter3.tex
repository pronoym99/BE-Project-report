...
\begin{figure}[h]
    \centering
        \includegraphics[width = 12cm, height = 5cm]{Chapter_3/axis_and_block.jpg}
    \caption{The X -  axis segment integrated with its respective wooden block as per the specifications mentioned in the previous section}
