...
\begin{figure}[h]
 ...
 \begin{subfigure}{0.5\textwidth}
  \hspace{5mm}
  \includegraphics[width=0.8\linewidth, height=6cm]{Chapter_4/dual_dc_regulated_power_supply.jpg}
 ...
 \begin{subfigure}{0.5\textwidth}
 \hspace{7mm}
  \includegraphics[width=0.8\linewidth, height=6cm]{Chapter_4/arduino_power.png}
